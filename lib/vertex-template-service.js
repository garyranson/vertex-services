...
var VertexTemplateService = (function () {
    ...
    VertexTemplateService.prototype.createTemplate = function (markup, viewController) {
        ...
        var rc = dom.querySelector("[px-node]");
        return this.templateFactory.createInstance(rc.cloneNode(true), viewController, actions, definitions);
    };
    VertexTemplateService.prototype._createTemplateActions = function (root) {
        ...
        while (el = walker.nextNode()) {
            ...
            if (attrs && attrs.length) {
                var actions = this.createActions(attrs);
    ...
    VertexTemplateService.prototype.createActions = function (attrs) {
        var _this = this;
...
VertexTemplateService._inject = [svg_helper_1.SvgHelper, actions_1.Actions, vertex_template_1.VertexTemplateFactory];
